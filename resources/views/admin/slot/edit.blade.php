...
<div class="flex items-center justify-between mb-8">
    <div>
        <h1 class="text-2xl font-semibold tracking-tight text-gray-900">Edit Slot</h1>
        <p class="text-sm text-gray-500 mt-1">Perbarui data slot penyimpanan</p>
    </div>
...
<div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden max-w-2xl">
    ...
    <form action="{{ route('admin.lumbung.slot.update', [$lumbung->id_lumbung, $slot->id_slot]) }}" method="POST" class="p-6 space-y-5">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <div class="relative">
                <input
                    ...
                    id="kapasitas"
                    name="kapasitas"
                    value="{{ old('kapasitas', $slot->kapasitas) }}"
                    placeholder="0"
                    min="{{ $terpakaiKg }}"
