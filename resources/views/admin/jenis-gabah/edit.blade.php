...
<div class="flex items-center justify-between mb-8">
    <div>
        <h1 class="text-2xl font-semibold tracking-tight text-gray-900">Edit Jenis Gabah</h1>
        <p class="text-sm text-gray-500 mt-1">Perbarui data jenis gabah</p>
    </div>
...
<div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden max-w-2xl">
    ...
    <form action="{{ route('admin.jenis-gabah.update', $jenisGabah->id_jenis_gabah) }}" method="POST" class="p-6 space-y-5">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input
                ...
                id="nama_jenis"
                name="nama_jenis"
                value="{{ old('nama_jenis', $jenisGabah->nama_jenis) }}"
