...
<div class="flex items-center justify-between mb-8">
    <div>
        <h1 class="text-2xl font-semibold tracking-tight text-gray-900">Tambah Kelompok Tani</h1>
        <p class="text-sm text-gray-500 mt-1">Buat kelompok tani baru</p>
    </div>
...
<div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden max-w-2xl">
    ...
    <form action="{{ route('admin.kelompok.store') }}" method="POST" class="p-6 space-y-5">
        @csrf
